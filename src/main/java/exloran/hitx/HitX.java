...
public class HitX implements ClientModInitializer {
    ...
    public static final int              TRAIL_LIFE  = 22; // tick
    ...
    public static final int            JUMP_RING_LIFE = 18;
    ...
    public void onInitializeClient() {
        ...
        ClientTickEvents.END_CLIENT_TICK.register(client -> {
            ...
            while (ji.hasNext()) {
                JumpRing jr = ji.next();
                jr.age++;
                jr.radius = 0.15f + (jr.age / (float)JUMP_RING_LIFE) * 2.2f;
