...
public class HitX implements ClientModInitializer {
    ...
    // ── Trail rengi: SARI sabit (NeonBoxRenderer'da override edilir) ─
    private static float trailHue = 0f; // artık kullanılmıyor
    ...
    public void onInitializeClient() {
        ...
        ClientTickEvents.END_CLIENT_TICK.register(client -> {
            ...
            // Trail — SARI sabit renk, hareket ederken iz bırak
            trailHue = 0f; // kullanılmıyor
            // Sarı RGB: r=1, g=0.85, b=0
