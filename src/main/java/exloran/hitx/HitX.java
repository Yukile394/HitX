...
public class HitX implements ClientModInitializer {
    ...
    private boolean isEating(LivingEntity e) {
        ...
        // Yemek yiyor mu veya içiyor mu?
        net.minecraft.item.ItemStack.UseAction action =
            using.getUseAction();
        return action == net.minecraft.item.ItemStack.UseAction.EAT
            || action == net.minecraft.item.ItemStack.UseAction.DRINK;
    }
