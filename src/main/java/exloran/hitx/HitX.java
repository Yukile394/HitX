    ...
    public class HitXMenu extends Screen {
        ...
        private void renderSettingsPanel(DrawContext ctx, MatrixStack ms, int mx, int my) {
            ...
            switch (settingsFor) {
                ...
                case "Particles" -> {
                    // Renk modu
                    ctx.drawTextWithShadow(textRenderer, "§7Particle Rengi:", ox+8, py, 0xFF9999BB);
                    py += 12;
                    ...
                    if (particleColorMode == 0) {
                        ...
                        ctx.drawCenteredTextWithShadow(textRenderer, "Particle Renk", ox+SP_W/2, py+4, 0xFFFFFFFF);
                        py += 22;
                        py = slider(ctx, ms, mx, my, ox+8, py, SP_W-16, "§cKırmızı",
