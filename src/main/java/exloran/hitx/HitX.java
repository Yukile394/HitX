...
public class HitX implements ClientModInitializer {
    ...
    private boolean isEating(LivingEntity e) {
        ...
        // 1.21.x: UseAction ayrı bir enum — net.minecraft.item.UseAction
        net.minecraft.item.UseAction action = using.getUseAction();
        return action == net.minecraft.item.UseAction.EAT
            || action == net.minecraft.item.UseAction.DRINK;
    }
