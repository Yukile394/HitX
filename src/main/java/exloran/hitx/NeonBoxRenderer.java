...
public class NeonBoxRenderer {
    ...
    private static void drawCenterSpinRing(MatrixStack ms, long time, float hw, float hh) {
        ...
        // Ana pembe halka
        drawCircle(mat, hw,        1.0f, 0.25f * pulse2, 0.85f * pulse2, 0.95f, 7.0f, 80);
        // İç parlama
        drawCircle(mat, hw * 0.88f, 1.0f, 0.5f * pulse, 1.0f * pulse, 0.85f, 3.0f, 64);
        ms.pop();
        ...
        drawCircle(mat2, hw * 0.9f, 0.8f * pulse, 0.3f, 1.0f * pulse, 0.88f, 5.0f, 72);
        ms.pop();
